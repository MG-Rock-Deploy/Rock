...
namespace Rock.Blocks.CMS
{
    ...
    [Rock.SystemGuid.EntityTypeGuid( "d6f46d76-d245-49bf-8314-0b229cdde2ee" )]
    [Rock.SystemGuid.BlockTypeGuid( "55d60cdc-0eee-45db-9541-cead531eb76a" )]
    public class MediaFolderDetail : RockObsidianDetailBlockType
    {
        ...
        private MediaFolderDetailOptionsBag GetBoxOptions( MediaFolderBag entity, RockContext rockContext )
        {
            ...
            if ( !string.IsNullOrWhiteSpace( entity.ContentChannel?.Value ) )
            {
                options.ContentChannelAttributes = GetContentChannelAttributes( entity.ContentChannel.Value.AsGuid(), rockContext );
            }
        ...
        private bool UpdateEntityFromBox( MediaFolder entity, DetailBlockBox<MediaFolderBag, MediaFolderDetailOptionsBag> box, RockContext rockContext )
        {
            ...
            box.IfValidProperty( nameof( box.Entity.MetricData ),
                () => entity.MetricData = box.Entity.MetricData );

            box.IfValidProperty( nameof( box.Entity.Name ),
                () => entity.Name = box.Entity.Name );

            box.IfValidProperty( nameof( box.Entity.SourceData ),
                () => entity.SourceData = box.Entity.SourceData );

            box.IfValidProperty( nameof( box.Entity.SourceKey ),
                () => entity.SourceKey = box.Entity.SourceKey );
        ...
        private static List<ListItemBag> GetContentChannelAttributes( Guid channelGuid, RockContext rockContext )
        {
            ...
            foreach ( var attribute in channelAttributes )
            {
                ...
                {
                    mediaElementAttributes.Add( new ListItemBag() { Text = attribute.Name, Value = attribute.Id.ToStringSafe() } );
                }
            }
